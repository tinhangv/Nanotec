"""Modules defining a Nanotec driver motion command for a BLDC motor.
...
class NanotecBldcMotionCommand(MotionCommand):
    """Implementation of the MotionCommand class for a BLDC motor connected to
    a Nanotec driver.
    ...
    @classmethod
    def from_json(cls, json: dict[str,]) -> "NanotecBldcMotionCommand":
        """Returns a NanotecBldcMotionCommand from the given JSOn object.

        Args:
            json: A JSON object to deserialize

        Returns:
            A NanotecBldcMotionCommand
        """
    ...
    def to_json(self) -> dict[str,]:
        ...
        Returns:
            A JSON object representing this NanotecBldcMotionCommand
        """
        json = {
